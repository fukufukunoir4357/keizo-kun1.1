...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite" do
    assert_difference('Favorite.count') do
      post favorites_url, params: { favorite: { language_id: @favorite.language_id, site_id: @favorite.site_id, user_id: @favorite.user_id } }
    end
  ...
  test "should update favorite" do
    patch favorite_url(@favorite), params: { favorite: { language_id: @favorite.language_id, site_id: @favorite.site_id, user_id: @favorite.user_id } }
